    ...
    async with pool.acquire() as conn:
        await conn.execute(
            ...
            ON CONFLICT (market_id, snapshot_ts) DO UPDATE SET
                ...
                predictive_score    = COALESCE(EXCLUDED.predictive_score, polymarket_market_stats.predictive_score),
                score_category      = COALESCE(EXCLUDED.score_category, polymarket_market_stats.score_category),
